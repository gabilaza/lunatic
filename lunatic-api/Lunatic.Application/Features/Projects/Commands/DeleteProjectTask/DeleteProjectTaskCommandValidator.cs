...
namespace Lunatic.Application.Features.Projects.Commands.DeleteProjectTask {
    internal class DeleteProjectTaskCommandValidator : AbstractValidator<DeleteProjectTaskCommand> {
        private readonly IProjectRepository projectRepository;

        private readonly ITaskRepository taskRepository;

        public DeleteProjectTaskCommandValidator(IProjectRepository projectRepository, ITaskRepository taskRepository) {
